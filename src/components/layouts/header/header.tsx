import { IconBox, Logo, SearchForm } from "@/components";
        ...
        <div className="container flex items-center justify-between py-4 md:py-6 xl:py-8">
          ...
          <ul className="hidden lg:flex gap-5">
            <li className="flex gap-2 cursor-pointer">
              <IconBox icon="icon-user" size={24} title={"Account"} link="#" hideTitleOnMobil={true}/>
            </li>
            <li className="flex gap-2 cursor-pointer">

            <IconBox icon="icon-user" size={24} title={"Account"} link="#" hideTitleOnMobil={true} badge={4}/>
