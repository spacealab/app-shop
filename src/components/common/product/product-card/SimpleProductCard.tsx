...
export function SimpleProductCard({data}: Props) {
    return (
        ...
        <ImageView src={data.attributes.thumbnail?.data?.attributes.url} className="m-auto w-full aspect-[3/2] mb-[28px]" alt="product" width={210} height={160}/>
        <div className="flex flex-col gap-2">
          { data.attributes.categories?.data[0].attributes.title && <div className="text-gray-500 text-xsmall">{data.attributes.categories?.data[0].attributes.title}</div>}
